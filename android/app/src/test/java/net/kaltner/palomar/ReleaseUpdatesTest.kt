...
class ReleaseUpdatesTest {
    ...
    private fun snapshot(
        serverSupported: PalomarRelease? = release("1.0.0"),
        serverNewest: PalomarRelease? = serverSupported,
        androidSupported: PalomarRelease? = serverSupported,
        androidNewest: PalomarRelease? = androidSupported,
        stale: Boolean = false,
    ...
    fun serverUpdatePreferenceFilesRemainHostScoped() {
        assertEquals("palomar_preferences.host-a", HostStore.preferenceFile("host-a"))
        assertEquals("palomar_preferences.host-b", HostStore.preferenceFile("host-b"))
