...
private val obsidianLightSemantic =
    PalomarSemanticColors(
        ...
        working = Color(0xFF655B69),
        workingContainer = Color(0xFFE8E4EA),
        attention = Color(0xFF8A4B00),
        attentionContainer = Color(0xFFFFF0CF),
        warning = Color(0xFF7B4A00),
        warningContainer = Color(0xFFFFF5D8),
...
private val obsidianDarkSemantic =
    PalomarSemanticColors(
        ...
        working = Color(0xFFA79BAB),
        workingContainer = Color(0xFF302C34),
...
internal fun palomarThemePalette(themeId: ThemeId): PalomarThemePalette =
    when (themeId) {
        ...
        ThemeId.NeonWave -> PalomarThemePalette(
            light = lightVariant(
                0xFFFCF6FB, 0xFFFFFFFF, 0xFFF5E9FA, 0xFFDFC9EC,
                0xFF24102F, 0xFF705B7D, 0xFFB30078, 0xFF007480,
                0xFFF9D7EA, 0xFF5A103D, 0xFFA83D5D, 0xFF007480,
                brandStructure = 0xFF713DB9,
                disabledSurface = 0xFFEBE7F0,
                disabledText = 0xFF716A7B,
                disabledBorder = 0xFFD4CCDF,
                semantic = neonWaveLightSemantic,
            ).copy(
                raisedSurface = Color(0xFFF4E9FA),
                card = Color(0xFFFFFFFF),
                groupedHeader = Color(0xFFEBD8F7),
                navigation = Color(0xFFF4E9FA),
                dialog = Color(0xFFFCF6FB),
                popover = Color(0xFFF4E9FA),
                usageFill = Color(0xFFA83D5D),
                contextFill = Color(0xFF007480),
            ),
            dark = darkVariant(
                0xFF070315, 0xFF100826, 0xFF1C0C3A, 0xFF4B2C78,
                0xFFFFF4FC, 0xFFBEB0CE, 0xFFFF3CAC, 0xFF2B0018,
                0xFF4DEBFF, 0xFF5A1248, 0xFFFFF0FA, 0xFFFF8A9F, 0xFF4DEBFF,
                brandStructure = 0xFFA864FF,
                disabledSurface = 0xFF211431,
                disabledText = 0xFF9B8DAA,
                disabledBorder = 0xFF422A59,
                semantic = neonWaveDarkSemantic,
            ).copy(
                raisedSurface = Color(0xFF1D0D3E),
                card = Color(0xFF160A33),
                groupedHeader = Color(0xFF2C1055),
                navigation = Color(0xFF0D0622),
                dialog = Color(0xFF1D0D3E),
                popover = Color(0xFF160A33),
                usageFill = Color(0xFFFF7794),
                contextFill = Color(0xFF4DEBFF),
            ),
        )
        ThemeId.Obsidian -> PalomarThemePalette(
            light = lightVariant(
                0xFFF6F7F8, 0xFFFFFFFF, 0xFFECEEF1, 0xFFD0D3D8,
                0xFF1C1E22, 0xFF626870, 0xFF7D3B52, 0xFF665E6B,
                0xFFE8E8EA, 0xFF3F363B, 0xFF754858, 0xFF7D3B52,
                brandStructure = 0xFF6F6875,
                disabledSurface = 0xFFE7E9EC,
                disabledText = 0xFF747980,
                disabledBorder = 0xFFCCD0D5,
                semantic = obsidianLightSemantic,
            ).copy(
                raisedSurface = Color(0xFFFFFFFF),
                card = Color(0xFFFFFFFF),
                groupedHeader = Color(0xFFECEEF1),
                navigation = Color(0xFFFFFFFF),
                dialog = Color(0xFFF6F7F8),
                popover = Color(0xFFFFFFFF),
                contextFill = Color(0xFF7D3B52),
            ),
            dark = darkVariant(
                0xFF0B0C0F, 0xFF13151A, 0xFF1C1E24, 0xFF3F4248,
                0xFFF4F5F6, 0xFFB3B6BC, 0xFFB65F78, 0xFF180508,
                0xFF958A9B, 0xFF292A2E, 0xFFF0EDEF, 0xFFC48698, 0xFFA86A7E,
                brandStructure = 0xFF958A9B,
                disabledSurface = 0xFF24262B,
                disabledText = 0xFF989CA3,
                disabledBorder = 0xFF393D43,
