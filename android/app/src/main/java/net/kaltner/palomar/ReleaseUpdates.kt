...
private const val RELEASE_NOTES_PREFIX = "https://github.com/kaltner-net/palomar/releases/tag/"
...
@Serializable
internal data class PalomarRelease(
    val version: String,
    val tag: String,
    val title: String,
...
internal data class ComponentReleaseUpdates(
    val supportedRelease: PalomarRelease? = null,
    val newestRelease: PalomarRelease? = null,
)
...
internal data class ComponentUpdateStatus(
    ...
    val release: PalomarRelease? = null,
)
...
private fun validRelease(release: PalomarRelease?, supported: Boolean): PalomarRelease? {
...
internal data class ServerUpdateCheck(
    ...
    val target: PalomarRelease? = null,
...
private const val OFFICIAL_RELEASE_SOURCE = "https://github.com/kaltner-net/palomar/releases"
private const val OFFICIAL_RELEASE_SOURCE_LABEL = "Official Palomar GitHub releases"

internal fun validatedServerUpdateOperation(value: ServerUpdateOperation?): ServerUpdateOperation? =
    value?.takeIf {
        it.id.matches(Regex("^pmu_[A-Za-z0-9_-]{16,80}$")) &&
            ...
            (it.recoveryCommand == null || it.recoveryCommand == "palomar update --recover")
    }
...
internal fun serverUpdatePhaseLabel(phase: String): String =
    mapOf(
        ...
        "restarting" to "Restarting Palomar",
